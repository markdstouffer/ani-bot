...
//   EmbedBuilder,
//   Interaction,
//   Message, MessageComponentInteraction, MessageInteraction,
//   SlashCommandBuilder
// } from 'discord.js'
...
//
//     const filter = async (m: MessageComponentInteraction) => {
//       const x = m.
...
//       await m.reply('Success! Your token will be encrypted and securely stored so that you can execute AniList-authenticated actions through Discord! Feel free to delete your token from this chat.')
...
//     }
//     reply.channel.({ filter, max: 1, time: 180000, errors: ['time']})
//   }
// }

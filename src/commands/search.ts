  ...
  async execute (interaction: CommandInteraction) {
    ...
    if (media.Media.isAdult && !channel.nsfw) {
      ...
      const embed: MessageEmbed = new Discord.MessageEmbed()
        ...
        .addField('Type: ', `\`${media.Media.type}\``, true)
      media.Media.type === 'ANIME'
        ? embed.addField('# of episodes: ', `${media.Media.episodes}`, true)
        : embed.addField('# of chapters', `${media.Media.chapters}`, true)
      ...
      if (media.Media.streamingEpisodes[0] && media.Media.type === 'ANIME') {
